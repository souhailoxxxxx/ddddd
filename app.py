...
cluster = MongoClient(["mongodb+srv://bloxywinner:entonnion123souhail123@cluster0.shucz5r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"])
...
app.config['JWT_SECRET_KEY'] = 'ahkaoadasdhhauiohi89qwyyu7asdgxbzhgzgyasuidhwuduwudhuwduhwudwuduwdhoaoksoasq0iw9'
...
def get_method():
    if not request.headers.get('Authorization') or request.headers.get('Authorization') != "123456123456":
